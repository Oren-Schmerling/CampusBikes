...
const LogoItem = () =>{
  return(
        <Link href="/" className="flex bg-waxwingGreen px-4 py-1.5 rounded-2xl items-center space-x-2 text-white hover:opacity-90 transition-opacity">
...
const NavBar = () => {
  ...
  return (
    <nav className="bg-lightGray py-2">
      <div className="px-2 mx-auto flex items-center justify-between">
        {LogoItem()}

        {/* Center - Main Navigation Links */}
        <div className="flex items-center space-x-8">
          <Link href="/home" className="flex bg-waxwingGreen items-center space-x-2 text-white hover:bg-green-900 px-4 py-2 rounded-2xl transition-colors">
            <Home className="w-5 h-5" />
            <span className="font-medium">Home</span>
          </Link>
          
          <Link href="/posting" className="flex bg-waxwingGreen items-center space-x-2 text-white hover:bg-green-900 px-4 py-2 rounded-2xl transition-colors">
            <FileText className="w-5 h-5" />
            <span className="font-medium">Posting</span>
          </Link>
          
          <Link href="/listings" className="flex bg-waxwingGreen items-center space-x-2 text-white hover:bg-green-900 px-4 py-2 rounded-2xl transition-colors">
