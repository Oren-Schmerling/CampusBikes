...
public class registrationUtil {
    ...
    public static EmailValidity  verifyEmail (String email) {
      ...
      } else if (!email.contains("umass.edu")){ // do NOT set this to "@umass.edu" because an alias like @cns.umass.edu would fail
    ...
    //todo: error handling
    public static int registrationHandler (String username, String pwHash, String email, String phone) throws URISyntaxException, IOException {
